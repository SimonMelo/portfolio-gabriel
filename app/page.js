    ...
    <div>
      ...
      <section id="inicio">
        <div id="home-section">
          ...
          <div className="animated-content" id="text-area">
            <blockquote>
              <h2>
                "O futuro pertence àqueles que estão dispostos a aprender e se adaptar"
              </h2>
      ...
      <section id="sobre-mim">
        <div id="about-section">
          ...
          <div id="skills" className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div className="col-span-full mb-4">
              <h2 id="title-skills" className="text-center font-bold">Principais Tecnologias</h2>
            </div>
            {['Javascript', 'NodeJS', 'ReactJS', 'NextJS', 'VueJS', 'Postman', 'ExpressJS', 'NestJS', '.NET', 'MySQL', 'SQLite', 'GIT'].map((skill) => (
              <div key={skill} className="skills-item bg-gray-100 p-4 rounded-md transition duration-300 ease-in-out hover:bg-red-500 hover:text-white">
      ...
      <section id="projetos">
        <div id="project-section" className="p-4 flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" id="div-projects">
            {[
              { title: 'Frontend de um formulário de pesquisa', link: 'https://github.com/SimonMelo/form-page' },
              { title: 'API de um formulário de pesquisa', link: 'https://github.com/SimonMelo/form-search-api' },
              { title: 'Frontend de um sistema de ponto', link: 'https://github.com/SimonMelo/Punching-system' },
              { title: 'API de um sistema de ponto', link: 'https://github.com/SimonMelo/puching-system-backend/tree/main/Backend' },
              { title: 'API de pagamento', link: 'https://github.com/SimonMelo/api-payment/tree/master' },
              { title: 'API de projeto universitário', link: 'https://github.com/SimonMelo/squad-1-api' },
            ].map((project) => (
              <div key={project.title} className="relative drop-shadow-xl w-48 h-64 overflow-hidden rounded-xl bg-[#ff0000]">
                <div className="absolute flex items-center justify-center text-white z-[1] opacity-90 rounded-xl inset-0.5 bg-[#323132]">
                  <div className="group relative flex flex-col items-center">
                    <span className="text-center font-bold">{project.title}</span>
                    <button className="group flex justify-center p-2 rounded-md drop-shadow-xl bg-gradient-to-r from-gray-800 to-black text-white font-semibold hover:translate-y-3 transition-all duration-500 hover:from-[#331029] hover:to-[#ff000]">
